...
export const MANIFEST_RELATIVE_PATH = ".prd-kit/manifest.json";
...
export function createEmptyManifest(rootDir: string, prdKitVersion: string): ManagedManifest {
  return {
